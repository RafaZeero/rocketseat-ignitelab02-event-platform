      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className='flex items-start gap-16'>
          ...
          <div className='flex flex-col gap-4' >
            <a href="" className="p-4 text-sm bg-green-500 flex items-center rounder font-bold gap-2 uppercase justify-center hover:bg-green-700 transition-colors" >
              <DiscordLogo size={24} />
              Comunidade do Discord
            </a>
            <a href="" className="p-4 text-sm border border-blue-500 text-blue-500 flex items-center rounder font-bold gap-2 uppercase justify-center hover:bg-blue-500 hover:text-gray-900 transition-colors" >
              <Lightning size={24} />
              Acesse o Desafio
            </a>
          </div>
