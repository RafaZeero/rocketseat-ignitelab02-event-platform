...
export default function Subscribe() {
  ...
  return (
    <div className='min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center' >
      <div className='w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto'>
        <div className='max-w-[640px]'>
          ...
          <h1 className='mt-8 text-[2.5rem] leading-tight'>
            Construa uma <strong className="text-blue-500">aplicação completa</strong>, do zero, <strong className="text-blue-500">com React</strong>.
          </h1>
        ...
        <div className='p-8 bg-gray-700 border border-gray-500 rounded'>
          ...
          <form onSubmit={handleSubscription} className='flex flex-col gap-2 w-full'>
            <input
      ...
      <img src="/src/assets/react-preview-img.png" alt="" />
    </div>
  )
}
